...
CREATE TABLE `apply` (
  ...
  CONSTRAINT `apply_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
...
CREATE TABLE `company` (
  ...
  PRIMARY KEY (`id`),
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `company_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`tech_stack_id`) REFERENCES `tech_stack` (`id`),
  CONSTRAINT `posts_ibfk_3` FOREIGN KEY (`education_id`) REFERENCES `education` (`id`),
  CONSTRAINT `posts_ibfk_4` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `resume_education` (
  ...
  CONSTRAINT `resume_education_ibfk_1` FOREIGN KEY (`school_id`) REFERENCES `school` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scrap` (
  ...
  KEY `post_id` (`post_id`),
  KEY `users_id` (`users_id`),
  CONSTRAINT `scrap_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
...
CREATE TABLE `sns_info` (
  ...
  `sns_connect_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
