...
VALUES ("서버/백엔드 개발자"), ("프론트엔드 개발자"), ("웹 풀스택 개발자"), ("안드로이드 개발자"), ("IOS 개발자");
...
VALUES
("레드캡스", "서울특별시 강남구 학동로 426"),
("티사각형", "서울특별시 서초구 남부순환로 2584"),
("네이트랩", "서울특별시 강남구 학동로 426"),
("직원임금", "서울특별시 구로구 가마산로 245"),
("매코기프트","서울특별시 관악구 관악로 145"),
("어스오즈", "경기도 성남시 분당구 분당로 50"),
("물병", "경기도 성남시 수정구 수정로 283"),
("피어리스어스", "서울특별시 마포구 월드컵로 212"),
("짜잇","서울특별시 마포구 월드컵로 212"),
("안내모빌리티", "서울특별시 서초구 남부순환로 2584"),
("다온에이아이", "서울특별시 서초구 남부순환로 2584"),
("SKA기술", "경기도 의왕시 시청로"),
("선택과집중", "인천광역시 연수구 원인재로 115"),
("로터리", "서울특별시 강남구 학동로 426"),
("노드추가", "경기도 성남시 분당구 분당로 50"),
("미나리", "서울특별시 구로구 가마산로 245"),
("어덜트기술", "서울특별시 금천구 시흥대로73길 70"),
("에투올", "인천광역시 연수구 원인재로 115"),
("물결과파도", "서울특별시 영등포구 당산로 123"),
("택배상자", "경기도 성남시 분당구 분당로 50"),
("소나기나비", "경기도 성남시 분당구 분당로 50"),
("편리", "서울특별시 서초구 남부순환로 2584"),
("충성", "서울특별시 서초구 남부순환로 2584"),
("마지막한끼", "서울특별시 마포구 월드컵로 212"),
("우리의 수업", "서울특별시 마포구 월드컵로 212"),
("도리두리", "울특별시 마포구 월드컵로 212"),
("초록개구리", "서울특별시 구로구 가마산로 245"),
("쿠브모", "서울특별시 금천구 시흥대로73길 70"),
("바둑이농장", "서울특별시 강남구 학동로 426"),
("빠른별", "서울특별시 강남구 학동로 426");

INSERT INTO
  company_tag(tag_id, company_id) 
VALUES 
(1,1),
(2,1),
(3,1),
...
• 보훈 대상자 우대
",
0, 4, 3, "2022-11-30", 40, 20);



INSERT INTO
  posts_tech_stack(posts_id, tech_stack_id) 
VALUES 
(1, 15),
(1, 9),
(1, 10),
...
TRUNCATE TABLE `company_tag`;
TRUNCATE TABLE `image`;
TRUNCATE TABLE `education`;
TRUNCATE TABLE `posts`;
TRUNCATE TABLE `posts_tech_stack`;
